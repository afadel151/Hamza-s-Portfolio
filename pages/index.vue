    ...
    <div>
        ...
        <div class="flex relative flex-col justify-between px-[20%] md:px-[400px] items-center mb-20  mt-40 ">
            ...
            <div class="w-full grid md:grid-cols-2 mt-28 gap-y-10 gap-x-20">
                ...
                <div class="w-full flex justify-between items-center">
                    <p class="text-xl text-white font-thin">User Research</p>
                    <div class="md:w-80 w-40 relative bg-white h-2 rounded-xl">
                        <div class="absolute h-2 w-[50%] bg-gradient-to-r from-violet-700 to-purple-500 rounded-full">
                ...
                <div class="w-full flex justify-between items-center">
                    <p class="text-xl text-white font-thin">UX Design</p>
                    <div class="md:w-80 w-40 relative bg-white h-2 rounded-xl">
                        <div class="absolute h-2 w-[50%] bg-gradient-to-r from-violet-700 to-purple-500 rounded-full">
                ...
                <div class="w-full flex justify-between items-center">
                    <p class="text-xl text-white font-thin">Prototyping</p>
                    <div class="md:w-80 w-40 relative bg-white h-2 rounded-xl">
                        <div class="absolute h-2 w-[50%] bg-gradient-to-r from-violet-700 to-purple-500 rounded-full">
                ...
                <div class="w-full flex justify-between items-center">
                    <p class="text-xl text-white font-thin">Responsive Design</p>
                    <div class="md:w-80 w-40 relative bg-white h-2 rounded-xl">
                ...
                <div class="w-full flex justify-between items-center">
                    <p class="text-xl text-white font-thin">Creativity</p>
                    <div class="md:w-80 w-40 relative bg-white h-2 rounded-xl">
                        <div class="absolute h-2 w-[50%] bg-gradient-to-r from-violet-700 to-purple-500 rounded-full">
